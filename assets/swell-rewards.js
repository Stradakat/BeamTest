...
(function () {
  ...
  SwellConfig.Campaign = {
    loadCampaigns: function () {
      ...
      $(".swell-campaign-list").append("<li class='swell-campaign'> <div class='swell-campaign-content' id='refer-campaign'> <div class='swell-campaign-icon'> <span class='swell-campaign-icon-content'><span class='swell-icon-raf-a-friend'><img style='width: 60px' src='https://cdn.shopify.com/s/files/1/0264/4076/1399/files/refer-a-friend.png?v=1642087581' /></span></span> <span class='swell-campaign-icon-content'><span class='swell-icon-raf-a-friend-hover'><img style='width: 60px' src='https://cdn.shopify.com/s/files/1/0264/4076/1399/files/refer-a-friend.png?v=1642087581' /></span></span> </div> <div class='campaign-content-holder'> <div class='swell-campaign-value'> <span class='swell-campaign-value-content'>Get $20</span> </div> <div class='swell-campaign-type'> <span class='swell-campaign-type-content'>Refer a Friend</span> </div> </div> </div> </li>");
    }
  };
}).call(this);
